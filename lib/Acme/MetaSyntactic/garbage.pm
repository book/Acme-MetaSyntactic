package Acme::MetaSyntactic::garbage;
use strict;
...
English list taken from L<http://dico.isc.cnrs.fr/dico/en/search>.
French list taken from L<http://dico.isc.cnrs.fr/dico/fr/search>.
